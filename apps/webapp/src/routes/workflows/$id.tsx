    ...
    <div className="p-6 max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">
              {isNew ? 'Create Workflow' : `Edit: ${formData.name}`}
            </h1>
            <p className="text-muted-foreground">
              Configure your document extraction pipeline
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, triggerTag: e.target.value })
                  }
          ...
          <section className="p-6 rounded-2xl border border-border bg-card space-y-4 text-card-foreground shadow-sm">
            ...
            <div className="rounded-xl border border-border overflow-hidden bg-[#1e1e1e] min-h-[300px]">
              <Editor
                ...
                onChange={(val) =>
                  setFormData({ ...formData, zodSource: val || '' })
                }
            ...
            {validationResult && (
              <div
                className={`p-4 rounded-xl text-sm border ${validationResult.valid ? 'bg-green-500/5 border-green-500/20 text-green-500' : 'bg-destructive/5 border-destructive/20 text-destructive'}`}
              >
        ...
        <div className="space-y-8">
          ...
          {/* Paperless Mapping */}
          <section className="p-6 rounded-2xl border border-border bg-card space-y-6 text-card-foreground shadow-sm">
            <div className="text-sm font-bold uppercase tracking-wider text-muted-foreground border-b border-border pb-2 mb-4">
              Paperless Output Mapping
            </div>
                ...
                onChange={(e) =>
                  setFormData({
                    ...
                    outputMapping: {
                      ...
                      correspondentField: e.target.value,
                    },
                  })
                }
                placeholder="vendor"
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, processedTag: e.target.value })
                }
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-[10px] text-muted-foreground">
                Fields from extraction to use as tags
              </p>
            </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="space-y-2">
                {Object.entries(formData.outputMapping.customFields).map(
                  ([key, value], index) => (
                    <div key={index} className="flex items-center gap-2">
                      <Input
                        value={key}
                        onChange={(e) =>
                          updateCustomFieldKey(key, e.target.value)
                        }
                      ...
                      <Input
                        value={value}
                        onChange={(e) =>
                          updateCustomFieldValue(key, e.target.value)
                        }
                ...
                {Object.keys(formData.outputMapping.customFields).length ===
                  0 && (
